...
Pod::Spec.new do |s|
  ...
  s.author             = { "Bjørn Vidar Dahle" => "bvidar@dahle.me" }
  # Or just: s.author    = "Bjørn Vidar Dahle"
  # s.authors            = { "Bjørn Vidar Dahle" => "bvidar@dahle.me" }
  # s.social_media_url   = "http://twitter.com/Bjørn Vidar Dahle"
